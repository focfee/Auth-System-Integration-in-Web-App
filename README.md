Вот отредактированная версия инструкции в стиле Markdown, подходящем для `README.md` на GitHub — с использованием заголовков, списков, форматирования кода и пояснений:
